...
def post_share(request, post_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'maxrosoft.dj.dev@ukr.net', [cd['to']])
            sent = True
        else:
            form = EmailPostForm()
            return render(request, 'main/posts/post/share.html',
...
def post_list(request, tag_slug=None):
    ...
    return render(request, 'main/posts/post/list.html', {'page': page, 'posts': posts, 'tag': tag})
...
def post_detail(request, year, month, day, post):
    ...
    return render(request, 'main/posts/post/detail.html', {'post': post,
                                                           'comments': comments,
